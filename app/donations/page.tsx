      ...
      <section className="mt-20 max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
            ...
            <Image src="/partners-images/JBC.png" alt="Just Beginnings Collaborative" width={120} height={60} className="mx-auto object-contain" />
            <Image src="/partner-images/JLC.png" alt="Junior League of Columbia" width={120} height={60} className="mx-auto object-contain" />
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
            ...
            <Image src="/partner-images/PP.png" alt="Palemtto Place" width={120} height={60} className="mx-auto object-contain" />
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
            ...
            <Image src="/partner-images/richland2.jfif" alt="Richland School District Two" width={120} height={60} className="mx-auto object-contain" />          </div>
        </div>
