...
export default async function Home() {
    ...
    return (
        <main className="min-h-screen bg-white text-gray-800">
            ...
            >
                ...
                <div className="relative z-10">
                    <h1 className="mx-auto max-w-5xl text-4xl font-medium leading-tight md:text-6xl">
                        ...
                        <span className="block text-8xl font-bold">First Step to Healing</span>
                    </h1>
            ...
            {/* Mission */ }
            <section
                className="mx-auto flex max-w-5xl flex-col items-center justify-center gap-8 px-6 py-20 text-center md:flex-row">
                <div>
                    <Image
                        src={ missionImageUrl }
                        alt="MissionImage"
