...
export const siteCopy = {
  ...
  "es-CO": {
      ...
      cards: [
        ...
        },
        {
          ...
          details: [
            ...
            "Somos reportantes obligatorias",
          ],
    ...
    donations: {
      ...
      partnersTitle: "Nuestras Aliadas y Aliados",
      partnerCategories: {
  ...
  "es-MX": {
    ...
    about: {
      ...
      founderNarrativeLabel: "Narrativa",
      founderNarrativeParagraphs: [
        "Defensora de toda la vida, Ashley combina su experiencia personal con una sólida formación académica, con una licenciatura en Psicología de Columbia College y una Maestría en Trabajo Social por la Universidad de Washington. Se distingue por su capacidad para movilizar personas, recursos e ideas con el fin de impulsar cambios sociales significativos.",
