    ...
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden lg:block">
          <Button asChild className="rounded-full bg-hive-orange px-5 py-2 text-sm font-semibold text-white hover:bg-hive-orange/90">
            <a
      ...
      {mobileOpen ? (
        <div className="border-t border-black/8 bg-white px-4 py-4 lg:hidden sm:px-6">
          <div className="space-y-2">
            ...
            <Button asChild className="mt-2 w-full rounded-full bg-hive-orange text-white hover:bg-hive-orange/90">
              <a
                href="https://thehivecc.networkforgood.com/projects/204053-what-is-hope"
                target="_blank"
                rel="noopener noreferrer"
