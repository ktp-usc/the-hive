...
export default function AboutTabs({
    ...
    const resolvedMissionTitle = missionTitle ?? "";
    const resolvedMissionBody = missionBody ?? "";
    const resolvedValuesTitle = valuesTitle ?? "";
    const resolvedValuesIntro = valuesIntro ?? "";
    const resolvedValuesPillars = valuesPillars?.length ? valuesPillars : [];
